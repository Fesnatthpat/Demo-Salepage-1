...
class AdminController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::guard('admin')->attempt($credentials, $remember)) {
            ...
            // บันทึกวันที่และ IP ที่เข้าใช้งานล่าสุด
        ...
        // บันทึก Log กรณี Login ไม่สำเร็จ
        ...
        return back()->withInput($request->only('username'))
            ->withErrors([
                'username' => 'ชื่อผู้ใช้หรือรหัสผ่านไม่ถูกต้อง หรือบัญชีของคุณถูกระงับ',
            ]);
    }
    ...
    public function update(Request $request)
    {
        ...
        // รายการ Settings ที่อนุญาตให้แก้ไข (Whitelist)
        $allowedSettings = [
            'site_name', 'footer_copyright', 'footer_slogan', 'site_phone', 'site_email', 'site_address',
            'social_facebook', 'social_twitter', 'social_instagram', 'social_line', 'faq_badge', 'footer_about_title',
            'footer_col2_link1_label', 'footer_col2_link1_url', 'footer_col2_link2_label', 'footer_col2_link2_url',
            'footer_col2_link3_label', 'footer_col2_link3_url', 'footer_col2_link4_label', 'footer_col2_link4_url',
            'footer_col3_link1_label', 'footer_col3_link1_url', 'footer_col3_link2_label', 'footer_col3_link2_url',
            'footer_col3_link3_label', 'footer_col3_link3_url', 'footer_col3_link4_label', 'footer_col3_link4_url',
            'home_recommended_badge', 'home_recommended_title', 'home_reasons_title',
        ...
        try {
            ...
            // ละเว้นข้อผิดพลาดจากการล้าง Cache
        }
