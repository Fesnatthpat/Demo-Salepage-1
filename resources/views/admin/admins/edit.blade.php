            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-400">แก้ไขรายละเอียดหรือเปลี่ยนรหัสผ่านของ: <span
                            class="font-semibold text-indigo-400">{{ $admin->username }}</span></p>
                </div>
                ...
                <div class="bg-gray-800 shadow-xl rounded-2xl overflow-hidden border border-gray-700">
                    <div class="p-8 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            {{-- Role --}}
                            <div class="col-span-2 sm:col-span-1">
                                <label for="role_id" class="block text-sm font-semibold text-gray-300 mb-2">ระดับสิทธิ์
                                    <span class="text-red-400">*</span></label>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="flex items-center space-x-6">
                                    <label class="inline-flex items-center cursor-pointer group">
                                        <input type="radio" name="is_active" value="1" class="hidden" {{ old('is_active', $admin->is_active) == '1' ? 'checked' : '' }}>
                                    ...
                                    <label class="inline-flex items-center cursor-pointer group">
                                        <input type="radio" name="is_active" value="0" class="hidden" {{ old('is_active', $admin->is_active) == '0' ? 'checked' : '' }}>
