            ...
            <div class="bg-gray-800 rounded-3xl border border-gray-700 overflow-hidden shadow-2xl">
                <div class="px-8 py-5 bg-gray-900/80 border-b border-gray-700 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="p-2.5 bg-pink-500/10 rounded-xl"><i class="fas fa-edit text-pink-400 text-xl"></i></div>
                        <div>
                            <h3 class="font-bold text-lg text-gray-100">แก้ไขรายละเอียด</h3>
                            <p class="text-xs text-gray-500">ปรับปรุงรูปภาพและข้อความที่จะแสดงบน LINE Flex Message</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative group">
                                    <div
                                        ...
                                        @php
                                            $imageUrl = $birthdayPromotion->image_path
                                                ? asset('storage/' . $birthdayPromotion->image_path)
                                                : 'https://placehold.co/1200x780/111827/4b5563?text=No+Image';
                                        @endphp
                                        <img src="{{ $imageUrl }}" class="w-full h-full object-cover"
                                            id="birthday-image-preview">
                                        <div
                            ...
                            {{-- Title --}}
                            <div class="space-y-2" x-data="{ title: '{{ old('title', addslashes($birthdayPromotion->title)) }}' }">
                            ...
                            {{-- Message --}}
                            <div class="space-y-2" x-data="{ message: '{{ old('message', addslashes($birthdayPromotion->message)) }}' }">
                                <div class="flex justify-between items-center">
                                    <label
                            ...
                            <div
                                ...
                                <div class="bg-white rounded-2xl overflow-hidden shadow-md flex flex-col">
                                    <div class="aspect-[20/13] w-full bg-gray-200">
                                        <img id="preview-img-card" src="{{ $imageUrl }}"
                    ...
                    <div class="mt-12 pt-8 border-t border-gray-700/50">
                        <div class="flex items-center gap-2 mb-6">
                            ...
                            <div>
                                <h3 class="font-bold text-gray-100">ตั้งเวลาแคมเปญล่วงหน้า <span
                                        class="text-xs bg-blue-500/20 text-blue-400 px-2 py-1 rounded-md ml-2">ตัวเลือกเสริม</span>
                                </h3>
                                <p class="text-xs text-gray-500 mt-1">หากไม่ระบุวันที่ ระบบจะใช้เป็น "แคมเปญพื้นฐาน"
                                    (ส่งตลอด)</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-2">
                                ...
                                <input type="date" name="start_date"
                                    value="{{ old('start_date', $birthdayPromotion->start_date?->format('Y-m-d')) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="date" name="end_date"
                                    value="{{ old('end_date', $birthdayPromotion->end_date?->format('Y-m-d')) }}"
                                    class="w-full bg-gray-900 border border-gray-700 rounded-xl px-4 py-3 text-gray-100 focus:ring-2 focus:ring-blue-500/50 outline-none">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 pt-8 border-t border-gray-700/50 grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="url" name="link_url"
                                value="{{ old('link_url', $birthdayPromotion->link_url) }}"
                ...
                <div class="px-8 py-6 bg-gray-900/50 border-t border-gray-700 flex justify-end">
                    <button type="submit"
                        class="px-10 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl shadow-lg transition-all transform hover:scale-105 active:scale-95">
