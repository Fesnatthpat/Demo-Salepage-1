...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div class="flex flex-wrap items-center gap-2 bg-gray-800 p-1.5 rounded-xl shadow-md border border-gray-700">
            ...
            <a href="{{ route('admin.dashboard', ['period' => 'last_30_days']) }}"
                class="{{ $commonClass }} {{ getBtnClass($period == 'last_30_days') }}">30 วัน</a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
        ...
        {{-- ✅ Calendar (ใช้ Tailwind overrides ทั้งหมด) --}}
        <div class="bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-700 flex flex-col">
            ...
            {{-- 
               กล่องปฏิทิน:
               ใช้ Tailwind Arbitrary Variants ([&_...]) เพื่อเจาะจง Styling ไปที่ element ภายใน FullCalendar โดยไม่ต้องเขียน CSS แยก
            --}}
            <div id='calendar'
                class="text-sm flex-grow min-h-[500px]
                {{-- สีพื้นหลังและตัวหนังสือ --}}
                bg-gray-800 text-gray-200
                
                {{-- ปรับส่วนหัว Toolbar (เดือน ปี) --}}
                ...
                {{-- 🔴 ลบสีพื้นหลังหัวตารางและเส้นขอบ (แก้ปัญหาหัวขาว) --}}
