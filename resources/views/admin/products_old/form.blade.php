                    ...
                    <div class="card-body">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" id="pd_name" name="pd_name"
                                value="{{ old('pd_name', $product->pd_name) }}" class="input input-bordered" required>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div class="form-control">
                                <label for="pd_code" class="label"><span class="label-text">รหัสสินค้า
                                        (SKU)*</span></label>
                                <input type="text" id="pd_code" name="pd_code"
                                    value="{{ old('pd_code', $product->pd_code) }}" class="input input-bordered" required>
                            </div>
                            <div class="form-control">
                                <label for="pd_price" class="label"><span class="label-text">ราคาขาย*</span></label>
                                <input type="number" step="0.01" id="pd_price" name="pd_price"
                                    value="{{ old('pd_price', $product->pd_price) }}" class="input input-bordered" required>
                            </div>
                            <div class="form-control">
                                <label for="pd_full_price" class="label"><span class="label-text">ราคาเต็ม
                                        (สำหรับแสดงส่วนลด)</span></label>
                                <input type="number" step="0.01" id="pd_full_price" name="pd_full_price"
                                    value="{{ old('pd_full_price', $product->pd_full_price) }}"
                ...
                <div class="space-y-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-control">
                                <label class="label cursor-pointer">
                                    ...
                                    <input type="checkbox" name="pd_status" value="1" class="toggle toggle-success"
                                        {{ old('pd_status', $product->pd_status) == 1 ? 'checked' : '' }} />
                    ...
                    <div class="card bg-white shadow-md">
                        <div class="card-body">
                            ...
                            @if ($product->pd_img)
                                <img src="{{ asset('images/' . ($product->pd_img ?? 'img.png')) }}"
                                    alt="{{ $product->pd_name }}" class="w-full h-auto rounded-lg mb-4">
                            @endif
