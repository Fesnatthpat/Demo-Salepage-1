            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-2 w-full sm:w-auto">
                        ...
                        <div class="form-control">
                            <div class="relative w-full">
                                <input type="text" name="search" placeholder="ค้นหาชื่อ หรือรหัสสินค้า..."
                                    class="input input-bordered w-full sm:w-56 pr-10" value="{{ request('search') }}">
                                <button type="submit"
                                    class="absolute top-0 right-0 rounded-l-none btn btn-square btn-sm btn-primary">
                    ...
                    <a href="{{ route('admin.products.create') }}"
                        class="btn btn-primary btn-block sm:btn-wide mt-2 sm:mt-0">
                            ...
                            <tr class="hover">
                                    ...
                                    <div class="avatar">
                                        <div class="mask mask-squircle w-12 h-12">
                                            <img src="{{ asset('images/' . ($product->pd_img ?? 'img.png')) }}"
                                                alt="{{ $product->pd_name ?? 'Product Image' }}">
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="flex justify-center items-center gap-2">
                                        ...
                                        <label for="delete-modal-{{ $product->pd_id }}"
                                    ...
                                    <div class="modal">
                                        <div class="modal-box">
                                            ...
                                            <p class="py-4">คุณแน่ใจหรือไม่ว่าต้องการลบสินค้า <span
                                                    class="font-bold">"{{ $product->pd_name }}"</span>?<br>การกระทำนี้ไม่สามารถย้อนกลับได้
                                            </p>
                                        ...
                                        <label class="modal-backdrop"
                                            for="delete-modal-{{ $product->pd_id }}">Close</label>
                                    </div>
                                </td>
                            </tr>
                        @empty
