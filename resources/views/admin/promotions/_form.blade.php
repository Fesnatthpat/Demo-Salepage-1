    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-4 space-y-6">
            <div class="card bg-white shadow-sm border border-gray-200">
                <div class="card-body p-6 gap-5">
                    ...
                    <div class="form-control w-full">
                        <label class="label pt-0"><span class="label-text font-semibold">ชื่อแคมเปญ <span
                                    class="text-error">*</span></span></label>
                        <input type="text" name="name"
                            class="input input-bordered w-full focus:input-primary bg-gray-50 focus:bg-white transition-colors"
                            value="{{ old('name', $promotion->name ?? '') }}" placeholder="เช่น Mid-Year Sale"
                            required />
                    </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        <textarea name="description"
                            class="textarea textarea-bordered h-24 focus:textarea-primary bg-gray-50 focus:bg-white resize-none">{{ old('description', $promotion->description ?? '') }}</textarea>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100 space-y-3">
                        ...
                        <div class="form-control w-full">
                            <label class="label py-0"><span
                                    class="label-text text-xs text-gray-500">วันเริ่มต้น</span></label>
                        ...
                        <div class="form-control w-full">
                            <label class="label py-0"><span
                                    class="label-text text-xs text-gray-500">วันสิ้นสุด</span></label>
            ...
            <div class="hidden lg:flex flex-col gap-3">
                <button type="submit" class="btn btn-primary w-full shadow-lg shadow-primary/30 font-bold text-lg">
                    <i class="fas fa-save"></i> บันทึกข้อมูล
                </button>
                <a href="{{ route('admin.promotions.index') }}" class="btn btn-ghost w-full text-gray-500">ยกเลิก</a>
            </div>
        </div>
        ...
        <div class="lg:col-span-8 space-y-6">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="p-6 bg-gray-50/50">
                        <div class="flex flex-col xl:flex-row gap-4 items-stretch relative">
                            ...
                            {{-- CARD 1: BUY --}}
                            <div
                                class="flex-1 w-full card bg-white border border-primary/20 shadow-sm relative overflow-visible group hover:shadow-md transition-shadow">
                                ...
                                <div class="card-body p-4">
                                    <div class="flex justify-between items-center mb-4 pb-2 border-b border-gray-100">
                                        ...
                                        <button type="button" @click="addItem('buy')"
                                            class="btn btn-xs btn-circle btn-primary text-white shadow-md hover:scale-110 transition"
                                            title="เพิ่มเงื่อนไข">
                                    ...
                                    <div class="space-y-3">
                                        <template x-for="(item, index) in buys" :key="index">
                                            <div
                                                class="p-3 bg-base-50 rounded-lg border border-base-200 relative group animate-fade-in-down">
                                                {{-- Remove Button --}}
                                                <button type="button" x-show="buys.length > 1"
                                                    @click="removeItem('buy', index)"
                                                    class="absolute -top-2 -right-2 btn btn-xs btn-circle btn-error text-white shadow-sm z-20 opacity-0 group-hover:opacity-100 transition-opacity">
                                                ...
                                                <div class="grid grid-cols-12 gap-2 items-end">
                                                    ...
                                                    <div class="col-span-4">
                                                        ...
                                                        <input type="number" :name="`buy_items[${index}][quantity]`"
                                                            ...
                                                            class="input input-bordered input-sm w-full text-center font-bold px-0"
                                                            required />
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            {{-- CARD 2: GET --}}
                            <div
                                class="flex-1 w-full card bg-white border border-secondary/20 shadow-sm relative overflow-visible group hover:shadow-md transition-shadow">
                                                ...
                                                <div class="form-control w-full text-center">
                                                    ...
                                                    <div class="join w-full justify-center">
                                                        ...
                                                        <input type="number" :name="`get_items[${index}][quantity]`"
                                                            x-model="item.quantity" min="1"
                                                            class="input input-bordered input-sm w-20 join-item text-center font-bold text-lg text-secondary"
                                                            required />
                                                        <button type="button" class="btn btn-sm join-item"
            ...
            <div class="lg:hidden flex justify-end items-center gap-3 pt-4 border-t border-gray-200 mt-4">
                <a href="{{ route('admin.promotions.index') }}" class="btn btn-ghost text-gray-500">ยกเลิก</a>
...
<style>
    ...
    /* TomSelect Customization for DaisyUI Theme */
    .ts-control {
        ...
        Alpine.data('promotionForm', () => ({
            ...
            init() {
                if (typeof TomSelect !== 'undefined') {
                    new TomSelect('#giftable-products-select', {
                        ...
                        render: {
                            item: function(data, escape) {
                                return '<div class="item badge badge-secondary badge-outline m-1 pl-2 pr-1 py-3 font-medium">' +
                                    escape(data.text) +
                                    '</div>';
                            }
                        }
                    ...
                    console.warn('TomSelect is missing. Please check your layout file.');
                }
            },
