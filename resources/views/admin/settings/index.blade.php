        ...
        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="xl:col-span-2 space-y-8">
                        ...
                        <div class="card-body p-6 space-y-6">
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="text" name="hero_section_tagline"
                                    ...
                                    value="{{ $settings['hero_section_tagline'] ?? 'ซื้อก่อน ลดก่อน' }}" />
                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div class="form-control">
                                        ...
                                        <input type="text" name="hero_section_title_prefix"
                                            ...
                                            value="{{ $settings['hero_section_title_prefix'] ?? 'สมาชิกช้อปสินค้า' }}" />
                                    </div>
                                    <div class="form-control">
                                        ...
                                        <input type="text" name="hero_section_title_highlight"
                                            ...
                                            value="{{ $settings['hero_section_title_highlight'] ?? 'SALE' }}" />
                                    </div>
                                    <div class="form-control">
                                        <label class="label-text-alt text-gray-400 mb-1">ส่วนหลัง</label>
                                        <input type="text" name="hero_section_title_suffix"
                                            class="input input-bordered w-full bg-gray-700 text-gray-100 text-sm"
                                            value="{{ $settings['hero_section_title_suffix'] ?? 'ก่อนใคร' }}" />
                                    </div>
                                </div>
                                <div class="mt-2 text-xs text-gray-500">
                                    ตัวอย่างที่แสดง: <span>{{ $settings['hero_section_title_prefix'] ?? '...' }}</span>
                                    <span
                                        class="text-blue-400 font-bold">{{ $settings['hero_section_title_highlight'] ?? '...' }}</span>
                                    <span>{{ $settings['hero_section_title_suffix'] ?? '...' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="form-control w-full">
                                ...
                                <textarea name="hero_section_description" rows="3"
                                    class="textarea textarea-bordered w-full bg-gray-700 text-gray-100 text-base leading-relaxed">{{ $settings['hero_section_description'] ?? 'ลดสูงสุด 50% | ที่ร้านและออนไลน์' }}</textarea>
                            </div>
                            ...
                            <div class="form-control w-full">
                                ...
                                <textarea name="hero_section_small_text" rows="2"
                                    class="textarea textarea-bordered w-full bg-gray-700 text-gray-400 text-sm">{{ $settings['hero_section_small_text'] ?? '*สินค้าและราคาของที่ร้านและออนไลน์อาจแตกต่างกัน' }}</textarea>
                            </div>
                        </div>
                    </div>

                    {{-- 1.1 Hero Section Sliders --}}
                    <div class="card bg-gray-800 shadow-xl border border-gray-700 rounded-xl overflow-hidden">
                        <div class="bg-gray-900/50 px-6 py-4 border-b border-gray-700 flex items-center gap-3">
                        ...
                        <div class="card-body p-6 space-y-6">
                            ...
                            <input type="hidden" name="hero_slider_items" id="hero_slider_items_input"
                                value="{{ old('hero_slider_items', $settings['hero_slider_items'] ?? '[]') }}">
                    ...
                    {{-- 1.2 Allergy Information Section --}}
                    <div class="card bg-gray-800 shadow-xl border border-gray-700 rounded-xl overflow-hidden">
                        <div class="bg-gray-900/50 px-6 py-4 border-b border-gray-700 flex items-center gap-3">
                        ...
                        <div class="card-body p-6 space-y-6">
                            <div class="form-control w-full">
                                ...
                                <textarea name="allergy_info_content" rows="5"
                                    class="textarea textarea-bordered w-full bg-gray-700 text-gray-100 text-base leading-relaxed">{{ $settings['allergy_info_content'] ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>

                    {{-- 1.3 6 Reasons Section --}}
                    <div class="card bg-gray-800 shadow-xl border border-gray-700 rounded-xl overflow-hidden">
                        <div class="bg-gray-900/50 px-6 py-4 border-b border-gray-700 flex items-center gap-3">
                        ...
                        <div class="card-body p-6 space-y-6">
                            ...
                            <input type="hidden" name="reasons_section_items" id="reasons_section_items_input"
                                value="{{ old('reasons_section_items', $settings['reasons_section_items'] ?? '[]') }}">
                    ...
                    <div class="card bg-gray-800 shadow-xl border border-gray-700 rounded-xl overflow-hidden">
                        ...
                        <div class="card-body p-6 space-y-6">
                            ...
                            <input type="hidden" name="second_slider_items" id="second_slider_items_input"
                                value="{{ old('second_slider_items', $settings['second_slider_items'] ?? '[]') }}">
                    ...
                    <div class="card bg-gray-800 shadow-xl border border-gray-700 rounded-xl overflow-hidden">
                        ...
                        <div class="card-body p-6 space-y-6">
                            ...
                            <input type="hidden" name="category_menu_items" id="category_menu_items_input"
                                value="{{ old('category_menu_items', $settings['category_menu_items'] ?? '[]') }}">
                    ...
                    {{-- 1.6 Small Slider on All Products Page --}}
                    <div class="card bg-gray-800 shadow-xl border border-gray-700 rounded-xl overflow-hidden">
                        <div class="bg-gray-900/50 px-6 py-4 border-b border-gray-700 flex items-center gap-3">
                        ...
                        <div class="card-body p-6 space-y-6">
                            ...
                            <input type="hidden" name="small_slider_allproducts_items" id="small_slider_allproducts_items_input"
                                value="{{ old('small_slider_allproducts_items', $settings['small_slider_allproducts_items'] ?? '[]') }}">
                                ...
                                <div
                                    ...
                                    @if (isset($settings['site_cover_image']))
                                        <div id="cover-image-preview-wrapper"
                                            ...
                                            <img src="{{ asset('storage/' . $settings['site_cover_image']) }}"
