...
@section('content')
    ...
    {{-- ★★★ HERO SECTION ★★★ --}}
    {{-- ลบ bg-white เพราะมีพื้นหลังที่ Body แล้ว --}}
    ...
    <div class="w-full pb-16 pt-10">
        <div class="container mx-auto px-4 mb-10">
            ...
            {{-- ★ เพิ่มพื้นหลังสีขาวโปร่งแสง (Glassmorphism) เพื่อให้อ่านง่าย --}}
                                            ...
                                            <div class="p-4 flex-1 flex flex-col">
                                                ...
                                                <div class="flex items-center justify-between mb-3">
                                                    <p
                                                        ...
                                                        {{ $product->pd_sp_stock > 0 ? '● มีสินค้า' : '● หมด' }}</p>
                ...
                <div class="swiper-wrapper">
                    ...
                    @else
                        @foreach (['th-a.png', 'th-b.png', 'th-c.png'] as $img)
                            <div class="swiper-slide"><img src="{{ asset('images/' . $img) }}"
    ...
    {{-- SERVICE BAR --}}
    {{-- ใช้ bg-white/95 เพื่อให้อ่านง่ายแต่ยังเห็นพื้นหลังจางๆ --}}
                        ...
                        <div class="flex flex-col items-center text-center group">
                            <div
                                ...
                                @if (str_contains($reason->icon, '<svg'))
                                    <div class="w-10 h-10">{!! $reason->icon !!}</div>
                                @else
