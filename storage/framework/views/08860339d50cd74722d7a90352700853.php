    ...
    <div class="min-h-[80vh] bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow-xl rounded-xl sm:px-10 border border-gray-100">
                <form class="space-y-6" action="<?php echo e(route('profile.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            ?>
                            <input type="date" name="date_of_birth" id="date_of_birth" required max="<?php echo e(date('Y-m-d')); ?>"
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\salepage-demo-1\resources\views/profile/completion.blade.php ENDPATH**/ ?>