...
<?php $__env->startSection('title', 'ตรวจสอบสถานะพัสดุ'); ?>
    ...
    <div class="container mx-auto p-4 lg:px-20 lg:py-10 max-w-4xl">
        <div class="bg-white border border-gray-200 rounded-lg p-6 lg:p-8 shadow-sm">
            ...
            <div class="flex justify-center mb-6">
                <img src="<?php echo e(asset('images/logo/logo1.png')); ?>" alt="Logo"
            ...
            <form action="<?php echo e(route('order.tracking')); ?>" method="POST" class="max-w-xl mx-auto">
                <?php echo csrf_field(); ?>
                <div
                    ...
                    <input type="text" name="order_code" placeholder="เช่น ORD-..."
                        ...
                        value="<?php echo e(old('order_code', $order->ord_code ?? '')); ?>" required />
                    <button type="submit"
                ...
                <div class="max-w-xl mx-auto mt-8 border-t border-gray-200 pt-8">
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-5 space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-gray-800"><?php echo e($order->ord_code); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-500">วันที่สั่งซื้อ:</span>
                            <span class="font-semibold text-gray-800"><?php echo e($order->created_at->format('d/m/Y H:i')); ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span
                                class="px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full <?php echo e($statusInfo['class']); ?>">
                                <i class="fas <?php echo e($statusInfo['icon']); ?> mr-2"></i> <?php echo e($statusInfo['text']); ?>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-gray-800">
                                ...
                                <?php echo e($order->tracking_number ?? 'ยังไม่มีหมายเลขพัสดุ'); ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\salepage-demo-1\resources\views/order/tracking_form.blade.php ENDPATH**/ ?>