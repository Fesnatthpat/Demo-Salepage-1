    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto">
                <form action="<?php echo e(route('admin.products.index')); ?>" method="GET" class="w-full sm:w-72 relative group">
            ...
            <div class="flex overflow-x-auto custom-scroll gap-2 p-2">
                ...
                <div class="flex bg-gray-900/50 p-1.5 rounded-xl border border-gray-700">
                    <a href="<?php echo e(route('admin.products.index', array_merge(request()->query(), ['status' => null, 'page' => null]))); ?>"
                        class="px-4 py-2 rounded-lg text-sm font-bold transition-all <?php echo e(request('status') === null ? 'bg-gray-700 text-white shadow' : 'text-gray-400 hover:text-gray-200'); ?>">
                        ทั้งหมด
                    </a>
                    <a href="<?php echo e(route('admin.products.index', array_merge(request()->query(), ['status' => '1', 'page' => null]))); ?>"
                        class="px-4 py-2 rounded-lg text-sm font-bold transition-all <?php echo e(request('status') === '1' ? 'bg-emerald-500/20 text-emerald-400 shadow' : 'text-gray-400 hover:text-emerald-400'); ?>">
                        ใช้งานอยู่
                    </a>
                    <a href="<?php echo e(route('admin.products.index', array_merge(request()->query(), ['status' => '0', 'page' => null]))); ?>"
                        class="px-4 py-2 rounded-lg text-sm font-bold transition-all <?php echo e(request('status') === '0' ? 'bg-red-500/20 text-red-400 shadow' : 'text-gray-400 hover:text-red-400'); ?>">
                        ระงับการขาย
                    </a>
                </div>
                ...
                <div class="flex bg-gray-900/50 p-1.5 rounded-xl border border-gray-700">
                    <a href="<?php echo e(route('admin.products.index', array_merge(request()->query(), ['type' => 'recommended', 'page' => null]))); ?>"
                        class="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all <?php echo e(request('type') == 'recommended' ? 'bg-yellow-500/20 text-yellow-400 shadow' : 'text-gray-400 hover:text-yellow-400'); ?>">
                    ...
                    <a href="<?php echo e(route('admin.products.index', array_merge(request()->query(), ['type' => 'promotion', 'page' => null]))); ?>"
                        class="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all <?php echo e(request('type') == 'promotion' ? 'bg-purple-500/20 text-purple-400 shadow' : 'text-gray-400 hover:text-purple-400'); ?>">
                    ...
                    <a href="<?php echo e(route('admin.products.index', array_merge(request()->query(), ['type' => 'out_of_stock', 'page' => null]))); ?>"
                        class="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all <?php echo e(request('type') == 'out_of_stock' ? 'bg-orange-500/20 text-orange-400 shadow' : 'text-gray-400 hover:text-orange-400'); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="hover:bg-gray-700/30 transition-colors group">
                                <td class="px-6 py-4 text-center">
                                    ...
                                    ?>
                                    <img src="<?php echo e($imagePath); ?>" alt="<?php echo e($product->pd_sp_name); ?>"
                                        class="mx-auto slip-thumbnail" data-slip-src="<?php echo e($imagePath); ?>"
                                    ...
                                    <div class="flex flex-col justify-center min-w-[250px]">
                                        ...
                                        <div class="flex items-center gap-2 mt-2">
                                            <span
                                                ...
                                                <?php echo e($product->pd_sp_code); ?></span>

                                            <button type="button"
                                                class="toggle-recommended-btn outline-none transition-transform active:scale-95"
                                                data-id="<?php echo e($product->pd_sp_id); ?>"
                                                data-url="<?php echo e(route('admin.products.toggleRecommended', $product->pd_sp_id)); ?>">
                                ...
                                <td class="px-6 py-4 text-right align-middle">
                                    <div class="font-bold text-gray-200 text-base">
                                        ฿<?php echo e(number_format($product->pd_sp_price, 2)); ?></div>
                                ...
                                <td class="px-6 py-4 text-center align-middle" x-data="{ isActive: <?php echo e($product->pd_sp_active ? 'true' : 'false'); ?>, isToggling: false }">
                                    <button type="button"
                                        @click="async () => {
                                            if(isToggling) return;
                                            isToggling = true;
                                            try {
                                                const res = await fetch(`/admin/products/<?php echo e($product->pd_sp_id); ?>/toggle-status`, {
                                                    method: 'POST',
                                        ...
                                        <div class="modal modal-bottom sm:modal-middle">
                                            <div
                                                ...
                                                <p class="text-gray-300 text-base whitespace-normal">คุณต้องการลบสินค้า
                                                    <span
                                                        class="font-bold text-white bg-gray-700 px-2 py-0.5 rounded">"<?php echo e($product->pd_sp_name); ?>"</span>
                                                    ใช่หรือไม่?</p>
                                                <p
