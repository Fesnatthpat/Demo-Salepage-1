...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto pb-24">
        ...
        <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="xl:col-span-2 space-y-8">
                    ...
                    <div class="card bg-gray-800 shadow-xl border border-gray-700 rounded-xl overflow-hidden">
                        ...
                        <div class="card-body p-6 space-y-6">
                            ...
                            <div class="p-4 bg-gray-700/30 rounded-xl border border-gray-700">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div class="form-control">
                                        ...
                                        <input type="text" name="hero_section_title_prefix" class="input input-bordered w-full bg-gray-700 text-gray-100 text-sm" value="<?php echo e($settings['hero_section_title_prefix'] ?? 'สมาชิกช้อปสินค้า'); ?>" />
                                    </div>
                                    <div class="form-control">
                                        <label class="label-text-alt text-blue-400 mb-1 font-bold">ส่วนเน้น (Highlight)</label>
                                        <input type="text" name="hero_section_title_highlight" class="input input-bordered w-full bg-gray-700 text-blue-300 font-bold text-sm border-blue-500/50" value="<?php echo e($settings['hero_section_title_highlight'] ?? 'SALE'); ?>" />
                                    </div>
                                    <div class="form-control">
                                        <label class="label-text-alt text-gray-400 mb-1">ส่วนหลัง</label>
                                        <input type="text" name="hero_section_title_suffix" class="input input-bordered w-full bg-gray-700 text-gray-100 text-sm" value="<?php echo e($settings['hero_section_title_suffix'] ?? 'ก่อนใคร'); ?>" />
                                    </div>
                                </div>
                                <div class="mt-2 text-xs text-gray-500">
                                    ตัวอย่างที่แสดง: <span><?php echo e($settings['hero_section_title_prefix'] ?? '...'); ?></span> <span class="text-blue-400 font-bold"><?php echo e($settings['hero_section_title_highlight'] ?? '...'); ?></span> <span><?php echo e($settings['hero_section_title_suffix'] ?? '...'); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="form-control w-full">
                                ...
                                <textarea name="hero_section_description" rows="3" class="textarea textarea-bordered w-full bg-gray-700 text-gray-100 text-base leading-relaxed"><?php echo e($settings['hero_section_description'] ?? 'ลดสูงสุด 50% | ที่ร้านและออนไลน์'); ?></textarea>
                            </div>
                            ...
                            <div class="form-control w-full">
                                ...
                                <textarea name="hero_section_small_text" rows="2" class="textarea textarea-bordered w-full bg-gray-700 text-gray-400 text-sm"><?php echo e($settings['hero_section_small_text'] ?? '*สินค้าและราคาของที่ร้านและออนไลน์อาจแตกต่างกัน'); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-gray-800 shadow-xl border border-gray-700 rounded-xl overflow-hidden">
                        ...
                        <div class="card-body p-6 space-y-6">
                            ...
                            <div class="form-control w-full">
                                <label class="label">
                                    <span class="label-text font-bold text-gray-300">รายละเอียดเว็บไซต์ (SEO & Footer)</span>
                                </label>
                                <textarea name="site_description" rows="3" class="textarea textarea-bordered w-full bg-gray-700 text-gray-100" placeholder="คำอธิบายสั้นๆ เกี่ยวกับเว็บไซต์ของคุณ"><?php echo e($settings['site_description'] ?? ''); ?></textarea>
                            </div>
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="hidden" name="service_bar_items" id="service_bar_items_input" value="<?php echo e(old('service_bar_items', $settings['service_bar_items'] ?? '[]')); ?>">
                                ...
                                <div class="bg-gray-700/30 p-4 rounded-xl border border-gray-600 space-y-4">
                                    ...
                                    <div id="service-empty-state" class="hidden text-center py-4 text-gray-500 text-sm border-2 border-dashed border-gray-600 rounded-lg">
                                    ...
                                    <div class="grid grid-cols-12 gap-2 items-center pt-3 border-t border-gray-600/50 mt-2">
                                        <div class="col-span-4">
                                            <div class="relative">
                                                <input type="text" id="new_service_icon" class="input input-sm input-bordered w-full bg-gray-800 text-white placeholder-gray-500 pl-8" placeholder="fa-check-circle">
                                                <i class="fas fa-icons absolute left-2.5 top-2 text-gray-500"></i>
                                            </div>
                                        </div>
                                        <div class="col-span-6">
                                            <input type="text" id="new_service_text" class="input input-sm input-bordered w-full bg-gray-800 text-white placeholder-gray-500" placeholder="เช่น สินค้าแท้ 100%">
                                        </div>
                                        <div class="col-span-2">
                                            <button type="button" onclick="addServiceItem()" class="btn btn-sm btn-success w-full text-white shadow-lg shadow-emerald-900/20">
                                                <i class="fas fa-plus"></i> <span class="hidden sm:inline ml-1">เพิ่ม</span>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="text-xs text-gray-500 mt-2">
                                        <i class="fas fa-info-circle mr-1"></i> ใช้ชื่อคลาสจาก <a href="https://fontawesome.com/v5/search" target="_blank" class="text-blue-400 hover:underline">FontAwesome 5</a> เช่น <code>fas fa-shipping-fast</code>, <code>fas fa-shield-alt</code>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card bg-gray-800 shadow-xl border border-gray-700 rounded-xl overflow-hidden sticky top-8">
                        ...
                        <div class="card-body p-6 space-y-8">
                            ...
                            <div class="form-control w-full">
                                ...
                                <div class="bg-gray-900/50 rounded-xl border border-gray-700 p-4 text-center group relative overflow-hidden transition-all hover:border-gray-600">
                                    <?php if(isset($settings['site_logo'])): ?>
                                        <div id="logo-preview-wrapper">
                                            <img src="<?php echo e(asset('storage/' . $settings['site_logo'])); ?>" alt="Site Logo" class="h-16 mx-auto object-contain">
                                            <button type="button" class="btn btn-xs btn-circle btn-error absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity delete-setting" data-key="site_logo" title="ลบรูปภาพ">
                                ...
                                <input type="file" name="site_logo" class="file-input file-input-bordered file-input-sm w-full bg-gray-700 mt-3 text-gray-300" accept="image/png, image/jpeg, image/webp" />
                            </div>
                            ...
                            <div class="form-control w-full">
                                ...
                                <div class="bg-gray-900/50 rounded-xl border border-gray-700 p-1 group relative overflow-hidden transition-all hover:border-gray-600">
                                    <?php if(isset($settings['site_cover_image'])): ?>
                                        <div id="cover-image-preview-wrapper" class="relative aspect-video rounded-lg overflow-hidden">
                                            ...
                                            <div class="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button type="button" class="btn btn-sm btn-error delete-setting" data-key="site_cover_image">
                                                    <i class="fas fa-trash mr-1"></i> ลบรูป
                                                </button>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="aspect-video rounded-lg bg-gray-800 flex flex-col items-center justify-center text-gray-600 border border-dashed border-gray-600">
                                            <i class="far fa-image text-4xl mb-2"></i>
                                            <span class="text-sm">ยังไม่มีรูปปก</span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <input type="file" name="site_cover_image" class="file-input file-input-bordered file-input-sm w-full bg-gray-700 mt-3 text-gray-300" accept="image/*" />
                            </div>
            ...
            <div class="fixed bottom-0 left-0 right-0 bg-gray-800/95 backdrop-blur-sm border-t border-gray-700 p-4 z-50 transition-transform duration-300 shadow-2xl">
                <div class="max-w-7xl mx-auto flex justify-between items-center">
                    ...
                    <div class="flex gap-3">
                        <a href="<?php echo e(route('home')); ?>" target="_blank" class="btn btn-ghost text-gray-300 hover:text-white">
        ...
        try {
            ...
            serviceItems = serviceItems.map(item => {
                if (item.icon && item.icon.includes('<svg')) {
                    return { icon: 'fas fa-check-circle', text: item.text }; // Default icon for migration
                }
                return item;
            });
    ...
    function renderServiceBuilder() {
        ...
        if (serviceItems.length === 0) {
            ...
            serviceItems.forEach((item, index) => {
                ...
                row.className = 'grid grid-cols-12 gap-2 items-center bg-gray-800/50 p-2 rounded-lg border border-gray-700/50 hover:border-gray-600 transition-colors';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.delete-setting').forEach(button => {
            button.addEventListener('click', function() {
                ...
                if (!key || !confirm(`คุณแน่ใจหรือไม่ว่าต้องการลบรูปภาพนี้? การกระทำนี้ไม่สามารถย้อนกลับได้`)) {
                    return;
                }
