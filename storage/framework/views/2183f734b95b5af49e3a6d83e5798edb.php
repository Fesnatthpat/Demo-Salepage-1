                ...
                <div class="space-y-6">
                    <div class="flex items-center gap-4 bg-white/10 p-4 rounded-xl backdrop-blur-sm border border-white/10">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-lg"><?php echo e($settings['contact_email'] ?? 'support@saledemo.com'); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 bg-white/10 p-4 rounded-xl backdrop-blur-sm border border-white/10">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-lg"><?php echo e($settings['contact_phone'] ?? '012-345-6789'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
