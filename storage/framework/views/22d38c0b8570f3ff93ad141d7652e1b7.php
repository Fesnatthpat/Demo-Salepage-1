...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <div>
            <h2 class="text-2xl font-semibold leading-tight">Edit Admin</h2>
        </div>
            ...
            <form action="<?php echo e(route('admin.admins.update', $admin->id)); ?>" method="POST">
                ...
                <div class="shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="username" id="username" value="<?php echo e(old('username', $admin->username)); ?>"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <select id="role" name="role"
                                    ...
                                    <option value="admin" <?php if($admin->role === 'admin'): ?> selected <?php endif; ?>>Admin</option>
                                    <option value="superadmin" <?php if($admin->role === 'superadmin'): ?> selected <?php endif; ?>>Super Admin</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                        <a href="<?php echo e(route('admin.admins.index')); ?>" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Cancel
                        </a>
                        <button type="submit"
