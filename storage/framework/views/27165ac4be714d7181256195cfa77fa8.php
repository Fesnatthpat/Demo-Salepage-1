<?php $__env->startSection('title', 'แก้ไขสินค้า'); ?>
...
<?php $__env->startSection('page-title'); ?>
    <div class="flex items-center gap-2 text-sm text-gray-400 overflow-x-auto whitespace-nowrap pb-1">
        ...
        <span class="text-gray-100 font-bold text-emerald-400 truncate max-w-[150px] sm:max-w-[300px]">
            <?php echo e($productSalepage->pd_sp_name); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto pb-36 md:pb-0">
        ...
        <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 animate-fade-in-down">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-1 font-mono">ID: <?php echo e($productSalepage->pd_sp_code); ?></p>
                </div>
            </div>

            
            <a href="<?php echo e(route('admin.products.review-images.show', $productSalepage->pd_sp_id)); ?>"
        ...
        <form action="<?php echo e(route('admin.products.update', $productSalepage->pd_sp_id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\salepage-demo-1\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>