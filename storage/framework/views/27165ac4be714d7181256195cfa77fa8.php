...
<?php $__env->startSection('page-title'); ?>
    <div class="flex items-center gap-2 text-sm text-gray-400">
        ...
        <span>/</span>
        <span class="text-gray-100 font-medium">แก้ไข: <?php echo e($productSalepage->pd_sp_name); ?></span>
    </div>
    ...
    <div class="max-w-7xl mx-auto">
        <form action="<?php echo e(route('admin.products.update', $productSalepage->pd_sp_id)); ?>" method="POST"
            ...
            <div class="text-center mt-8">
                <a href="<?php echo e(route('admin.products.review-images.show', $productSalepage->pd_sp_id)); ?>" class="btn btn-secondary">
