                ...
                <form class="space-y-6" action="<?php echo e(route('profile.update')); ?>" method="POST">
                    ...
                    <div>
                        ...
                        <select id="gender" name="gender"
                            ...
                            <option value="male" <?php if(old('gender', $user->gender) == 'male'): ?> selected <?php endif; ?>>ชาย (Male)</option>
                            <option value="female" <?php if(old('gender', $user->gender) == 'female'): ?> selected <?php endif; ?>>หญิง (Female)</option>
                            <option value="other" <?php if(old('gender', $user->gender) == 'other'): ?> selected <?php endif; ?>>อื่นๆ (Other)</option>
                        </select>
                    </div>
