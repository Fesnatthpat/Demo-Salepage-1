...
<?php $__env->startSection('title', 'สร้างเนื้อหา "เกี่ยวกับติดใจ"'); ?>
...
<div class="bg-gray-800 rounded-xl shadow-2xl p-6 border border-gray-700">
    ...
    <form action="<?php echo e(route('admin.favorites.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div class="xl:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="<?php echo e(old('title')); ?>" required placeholder="เช่น ยินดีต้อนรับ, วิสัยทัศน์ของเรา, หรือ ติดต่อเรา"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="8" required placeholder="ใส่รายละเอียดเนื้อหาที่นี่..."
                              class="block w-full bg-gray-900 border-gray-600 rounded-lg shadow-sm text-white focus:ring-red-500 focus:border-red-500 px-4 py-3 leading-relaxed"><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="mt-8 pt-6 border-t border-gray-700 flex justify-end gap-4">
            <a href="<?php echo e(route('admin.favorites.index')); ?>" class="btn btn-ghost text-gray-300 hover:bg-gray-700">ยกเลิก</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\salepage-demo-1\resources\views/admin/favorites/create.blade.php ENDPATH**/ ?>