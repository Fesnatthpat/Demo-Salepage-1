        ...
        <div class="p-6 md:p-8 space-y-6">
            ...
            <div class="form-control w-full">
                ...
                <textarea name="pd_sp_details" rows="5"
                    class="textarea w-full bg-gray-900 border border-gray-600 text-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 rounded-xl leading-relaxed p-4"><?php echo e(old('pd_sp_details', $productSalepage->pd_sp_description ?? '')); ?></textarea>
            </div>
        </div>
    </div>
                ...
                <div class="form-control w-full relative">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="pd_sp_price"
                            value="<?php echo e(old('pd_sp_price', $productSalepage->pd_sp_price ?? '')); ?>"
                ...
                <div class="mt-8">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4" id="image-list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $productSalepage->images->sortBy('img_sort'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            ...
                            ?>
                            <div class="relative group rounded-2xl overflow-hidden border-2 <?php echo e($borderColor); ?> bg-gray-900 aspect-square flex items-center justify-center transition-all"
                                id="image-card-<?php echo e($image->img_id); ?>">

                                <img src="<?php echo e($imagePath); ?>" alt="Product Image"
