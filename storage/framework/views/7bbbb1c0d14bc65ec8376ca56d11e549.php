        ...
        <div class="bg-gray-50 h-[700px] overflow-y-auto relative font-sans">
                ...
                <div class="container mx-auto px-4 relative z-10 text-center">
                    <div class="mb-6 flex justify-center">
                        <div class="p-4 bg-white/10 backdrop-blur-md rounded-full shadow-xl ring-4 ring-white/20">
                            ...
                            <img src="<?php echo e($siteLogoUrl); ?>" class="h-16 w-auto drop-shadow-lg object-contain"
                                onerror="this.src='https://via.placeholder.com/150x150?text=LOGO';" />
                        </div>
                    </div>
                    <h1 class="text-3xl md:text-5xl font-extrabold mb-3 tracking-wide text-shadow-lg"><?php echo e($aboutTitle); ?>

                    </h1>
                    <p class="text-red-100 text-base md:text-lg font-light max-w-2xl mx-auto"><?php echo e($aboutSub); ?></p>
                </div>
            </div>
            ...
            <div class="container mx-auto px-4 -mt-16 relative z-20 pb-16">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $favorites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $fav): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div
                        class="bg-white rounded-3xl shadow-lg p-8 mb-8 border-b-4 <?php echo e($fav->is_active ? 'border-red-500' : 'border-gray-400 opacity-60'); ?> relative group transition-all duration-300">
                        <div
                        ...
                        <div class="flex flex-col md:flex-row items-center gap-8">
                            <div
                                class="w-full <?php echo e($fav->image_path ? 'md:w-1/2' : ''); ?> <?php echo e($index % 2 == 0 ? 'order-2 md:order-1' : 'order-2 md:order-2'); ?>">
                                <div class="flex items-center gap-3 mb-4"><span
                                        class="w-1.5 h-6 bg-red-600 rounded-full"></span>
                                    <h2 class="text-2xl font-bold text-gray-800"><?php echo e($fav->title); ?></h2>
                                </div>
                                <p class="text-gray-600 leading-relaxed whitespace-pre-line"><?php echo e($fav->content); ?></p>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fav->image_path): ?>
                                <div
                                    class="w-full md:w-1/2 <?php echo e($index % 2 == 0 ? 'order-1 md:order-2' : 'order-1 md:order-1'); ?>">
            ...
            <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" enctype="multipart/form-data"
                ...
                <div id="setting_contact_fields" class="space-y-4 hidden">
                    ...
                    <div>
                        ...
                        <input type="email" name="settings[contact_email]" value="<?php echo e($email); ?>"
                            class="w-full bg-gray-900 border-gray-600 text-white rounded-lg p-3 border">
                    </div>
                    <div>
