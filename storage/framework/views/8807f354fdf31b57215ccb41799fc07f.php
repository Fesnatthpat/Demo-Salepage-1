...
<?php $__env->startSection('title', 'จัดการรูปรีวิว'); ?>
...
<?php $__env->startSection('page-title'); ?>
    <div class="flex items-center gap-2 text-sm text-gray-400 overflow-x-auto whitespace-nowrap pb-1">
        ...
        <a href="<?php echo e(route('admin.products.edit', $product->pd_sp_id)); ?>" class="hover:text-emerald-400 transition-colors">
            แก้ไข: <?php echo e($product->pd_sp_name); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-6xl mx-auto pb-10">
        ...
        <div x-data="{
            ...
            <form action="<?php echo e(route('admin.products.review-images.store', $product->pd_sp_id)); ?>" method="POST"
        ...
        <div class="bg-gray-800 rounded-3xl shadow-lg border border-gray-700 p-6 md:p-10">
            <div class="flex items-center justify-between mb-8 border-b border-gray-700/50 pb-4">
                <h2 class="text-xl font-bold text-white flex items-center gap-3">
                    ...
                    รูปรีวิวทั้งหมด
                    <span
                        class="badge bg-blue-500 border-none text-white font-bold ml-2"><?php echo e($product->reviewImages->count()); ?></span>
                </h2>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->reviewImages->isEmpty()): ?>
            ...
            <?php else: ?>
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $product->reviewImages->sortByDesc('sort_order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div
                            ...
                            <img src="<?php echo e(filter_var($image->image_url, FILTER_VALIDATE_URL) ? $image->image_url : asset('storage/' . $image->image_url)); ?>"
                                alt="Review Image"
                            ...
                            <div
                                ...
                                <form action="<?php echo e(route('admin.products.review-images.destroy', $image->id)); ?>"
                                    method="POST"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\salepage-demo-1\resources\views/admin/products/review-images.blade.php ENDPATH**/ ?>