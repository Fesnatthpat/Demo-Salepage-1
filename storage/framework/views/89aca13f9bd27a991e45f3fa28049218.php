                ...
                <div class="card-body p-6 gap-5">
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text" name="name"
                            ...
                            value="<?php echo e(old('name', $promotion->name ?? '')); ?>" placeholder="เช่น Mid-Year Sale"
                            required />
                    </div>
                    ...
                    <div class="form-control w-full">
                        ...
                        <textarea name="description"
                            class="textarea textarea-bordered h-24 focus:textarea-primary bg-gray-50 focus:bg-white resize-none"><?php echo e(old('description', $promotion->description ?? '')); ?></textarea>
                    </div>
                                                    ...
                                                    <div class="col-span-8">
                                                        ...
                                                        <select :name="`buy_items[${index}][product_id]`"
                                                            ...
                                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($p->pd_sp_id); ?>"><?php echo e($p->pd_sp_name); ?>
