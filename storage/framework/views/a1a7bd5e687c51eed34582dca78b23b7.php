            ...
            <div class="grid grid-cols-1 lg:grid-cols-12">
                ...
                <div class="lg:col-span-7 p-8 lg:p-12 flex flex-col">
                    <div class="flex-1">
                        ...
                        <div class="mb-10">
                            <h3 class="text-sm font-black text-gray-900 uppercase mb-3 flex items-center">
                                <span class="w-8 h-px bg-emerald-500 mr-2"></span> รายละเอียดสินค้า
                            </h3>
                        ...
                        <?php if($giftableProducts->isNotEmpty()): ?>
                            <div class="mb-10 p-6 rounded-2xl border-2 border-dashed border-red-100 bg-red-50/30 relative">
                                <div
                                    class="absolute -top-3 left-6 bg-red-500 text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-md">
                                    EXCLUSIVE GIFT</div>
                                <p class="text-sm font-bold text-gray-800 mb-4"><?php echo e($promotionName); ?></p>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <?php $__currentLoopData = $giftableProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div @click="selectedGift = <?php echo e($gift->pd_sp_id); ?>"
                                            class="flex items-center gap-4 p-3 bg-white rounded-xl border-2 cursor-pointer transition-all duration-300"
                                            :class="selectedGift === <?php echo e($gift->pd_sp_id); ?> ?
                                                'border-emerald-500 bg-emerald-50' : 'border-gray-50'">
                                            <div
                                                class="w-12 h-12 rounded-lg overflow-hidden flex-shrink-0 border border-gray-100">
                                                <img src="<?php echo e($gift->display_image); ?>" class="w-full h-full object-cover">
                                            </div>
                                            <div class="flex-1 overflow-hidden">
                                                <p class="text-[11px] font-bold text-gray-800 truncate">
                                                    <?php echo e($gift->pd_sp_name); ?></p>
                                                <span class="text-[10px] text-red-500 font-bold">ฟรี
                                                    <?php echo e($gift->gift_quantity); ?> ชิ้น</span>
                                            </div>
                        ...
                        try {
                            const response = await fetch(config.standardAction, {
                                ...
                                body: JSON.stringify({
                                    ...
                                    selected_gift_id: this.selectedGift
                                })
                            });
