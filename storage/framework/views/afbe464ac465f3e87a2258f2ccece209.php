            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-300">
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-100">
                        <?php echo e($customer->gender ? $genderMap[strtolower($customer->gender)] ?? $customer->gender : '-'); ?>
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-100">
                        <?php echo e($customer->date_of_birth ? \Carbon\Carbon::parse($customer->date_of_birth)->locale('th')->translatedFormat('d M ') . (\Carbon\Carbon::parse($customer->date_of_birth)->year + 543) : '-'); ?>
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-100">
                        <?php echo e($customer->created_at ? $customer->created_at->locale('th')->translatedFormat('d M ') . ($customer->created_at->year + 543) . ' เวลา ' . $customer->created_at->format('H:i') : '-'); ?>
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-gray-100">
                        <?php echo e($customer->updated_at ? $customer->updated_at->locale('th')->translatedFormat('d M ') . ($customer->updated_at->year + 543) . ' เวลา ' . $customer->updated_at->format('H:i') : '-'); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $customer->orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="hover:bg-gray-700/50 transition-colors border-b border-gray-700 last:border-0">
                                ...
                                <td class="text-gray-400">
                                    <?php echo e($order->ord_date ? $order->ord_date->locale('th')->translatedFormat('d M ') . ($order->ord_date->year + 543) . ' เวลา ' . $order->ord_date->format('H:i') : '-'); ?>
