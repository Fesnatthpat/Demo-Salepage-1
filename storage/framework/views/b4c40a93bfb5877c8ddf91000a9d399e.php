...
<?php $__env->startSection('title', 'เข้าสู่ระบบ | Salepage Demo'); ?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex justify-center items-center min-h-[calc(100vh-100px)] py-10">
            ...
            <div class="w-full max-w-sm bg-white p-8 rounded-xl shadow-lg border border-gray-100 text-center">
                ...
                <a href="<?php echo e(route('login.line')); ?>"
                    ...
                    <svg class="w-7 h-7 fill-current" viewBox="0 0 576 576" 
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\salepage-demo-1\resources\views/login.blade.php ENDPATH**/ ?>