        ...
        <aside class="flex-shrink-0 w-64 flex flex-col border-r transition-all duration-300 bg-white"
            ...
            <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-emerald-100 text-emerald-700 font-semibold' : 'hover:bg-gray-100'); ?>">
                    <i class="fas fa-tachometer-alt mr-3 w-5 text-center"></i>
                    แดชบอร์ด
                </a>
                <a href="<?php echo e(route('admin.orders.index')); ?>"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-emerald-100 text-emerald-700 font-semibold' : 'hover:bg-gray-100'); ?>">
                    <i class="fas fa-shopping-cart mr-3 w-5 text-center"></i>
                    ออเดอร์
                </a>
                <a href="<?php echo e(route('admin.products.index')); ?>"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.products.*') ? 'bg-emerald-100 text-emerald-700 font-semibold' : 'hover:bg-gray-100'); ?>">
                    <i class="fas fa-boxes mr-3 w-5 text-center"></i>
                    จัดการสินค้า
                </a>
                <a href="<?php echo e(route('admin.customers.index')); ?>"
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.customers.*') ? 'bg-emerald-100 text-emerald-700 font-semibold' : 'hover:bg-gray-100'); ?>">
                    <i class="fas fa-users mr-3 w-5 text-center"></i>
                    ลูกค้า
                </a>
                                <a href="<?php echo e(route('admin.promotions.index')); ?>"
                                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.promotions.*') ? 'bg-emerald-100 text-emerald-700 font-semibold' : 'hover:bg-gray-100'); ?>">
                                ...
                                <a href="<?php echo e(route('admin.activity-log.index')); ?>"
                                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.activity-log.*') ? 'bg-emerald-100 text-emerald-700 font-semibold' : 'hover:bg-gray-100'); ?>">
                                    <i class="fas fa-history mr-3 w-5 text-center"></i>
                                    ประวัติกิจกรรม
                                </a>
                                <a href="<?php echo e(route('admin.admins.index')); ?>"
                                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.admins.*') ? 'bg-emerald-100 text-emerald-700 font-semibold' : 'hover:bg-gray-100'); ?>">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <header class="flex justify-between items-center p-4 bg-white border-b shadow-sm z-20">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl font-semibold ml-4 text-gray-800"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
                </div>
