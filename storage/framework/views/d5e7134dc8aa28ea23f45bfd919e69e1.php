            ...
            <div class="navbar min-h-[4rem] px-0">
                    ...
                    <div class="dropdown md:hidden">
                        ...
                        <ul tabindex="-1"
                            ...
                            <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e($item['url']); ?>" class="py-3 font-bold"><?php echo e($item['name']); ?></a></li>
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <li><a href="/orderhistory" class="py-3 font-bold">ประวัติการสั่งซื้อ</a></li>
                                        ...
                                        <?php endif; ?>
                                        <span class="font-bold text-gray-700"><?php echo e(auth()->user()->name); ?></span>
                                    </div>
                                </li>
                                <li>
                ...
                <div class="navbar-center">
                    ...
                    <ul class="menu menu-horizontal px-1 gap-6 text-base font-medium text-gray-600 hidden md:flex">
                        <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="<?php echo e($item['url']); ?>" class="hover:text-emerald-600 hover:bg-transparent"><?php echo e($item['name']); ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if(auth()->guard()->check()): ?>
                ...
                <div class="navbar-end flex items-center gap-2 md:gap-4">
                    ...
                    <a href="/cart" class="btn btn-ghost btn-circle relative hover:bg-gray-100">
                        <div class="indicator">
                            ...
                            <span id="cart-badge"
                                class="badge badge-sm indicator-item bg-red-500 text-white border-none <?php echo e($cartCount > 0 ? '' : 'hidden'); ?>">
                        ...
                        <div class="dropdown dropdown-end hidden md:block">
                            <div tabindex="0" role="button"
                                ...
                                <div class="w-10 rounded-full">
                                    ...
                                    <?php else: ?>
                                        <img
                                            src="https://ui-avatars.com/api/?name=<?php echo e(auth()->user()->name); ?>&background=0D8ABC&color=fff" />
                                    <?php endif; ?>
                                </div>
                            </div>
                            <ul tabindex="-1"
                                ...
                                <li>
                                    <a href="<?php echo e(route('profile.edit')); ?>" class="w-full text-left py-3 px-4 text-gray-700 hover:bg-gray-100 hover:text-gray-800 rounded-lg flex items-center gap-3 transition-colors duration-200">
                                ...
                                <li>
                                    <form action="<?php echo e(route('logout')); ?>" method="POST" class="w-full p-0 block">
