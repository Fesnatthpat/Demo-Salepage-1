<?php $__env->startSection('title', 'หน้าหลัก | Salepage Demo'); ?>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center divide-x divide-gray-100">
                ...
                <?php $__currentLoopData = $serviceBarItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex flex-col items-center gap-2 group">
                        ...
                        <span class="text-sm font-semibold text-gray-700"><?php echo e($item['text']); ?></span>
                    </div>
                ...
                <?php $__currentLoopData = $recommendedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div
                        ...
                        <div class="card-body p-4 flex-1 flex flex-col">
                            ...
                            <p class="text-xs text-gray-500">Code: <?php echo e($product->pd_sp_code); ?></p>
                            <p class="text-xs <?php echo e($product->pd_sp_stock > 0 ? 'text-emerald-600' : 'text-red-500'); ?>">
                            ...
                            <div class="mt-auto">
                                <button type="button"
                                    ...
                                    class="btn btn-sm w-full <?php echo e($product->pd_sp_stock > 0 ? 'btn-outline border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white hover:border-emerald-600' : 'btn-disabled bg-gray-200'); ?> font-bold gap-2"
