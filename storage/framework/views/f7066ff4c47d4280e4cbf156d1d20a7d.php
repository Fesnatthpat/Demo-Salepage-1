        ...
        <div class="py-8">
            ...
            <?php if($filter_admin_name): ?>
                <div class="mt-4 bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4" role="alert">
                    ...
                    <a href="<?php echo e(route('admin.activity-log.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800">Clear
                        Filter</a>
                </div>
            <?php endif; ?>
                                                    ...
                                                    <?php $__currentLoopData = $activity->changes['new']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute => $newValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if(isset($activity->changes['original'][$attribute])): ?>
                                                            <?php if($activity->changes['original'][$attribute] != $newValue): ?>
                                                                <p><strong><?php echo e($attribute); ?>:</strong> <span
                                                                        class="text-red-600"><?php echo e($activity->changes['original'][$attribute]); ?></span>
                                                                    &rarr; <span
                                                                        class="text-green-600"><?php echo e($newValue); ?></span>
                                                                </p>
                                                            <?php endif; ?>
                                                        <?php else: ?>
                                                            <p><strong><?php echo e($attribute); ?>:</strong> <span
                                                                    class="text-green-600">Added:
                                                                    <?php echo e($newValue); ?></span></p>
                                                        <?php endif; ?>
