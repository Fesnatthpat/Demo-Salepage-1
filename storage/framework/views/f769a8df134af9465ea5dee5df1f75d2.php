<?php $__env->startSection('title', 'รายละเอียดออเดอร์ ' . $order->ord_code); ?>
    ...
    <div
        ...
        <div>
            <h1 class="text-2xl md:text-3xl font-extrabold text-white tracking-tight flex items-center gap-3">
                ...
                <button onclick="navigator.clipboard.writeText('<?php echo e($order->ord_code); ?>'); alert('คัดลอกรหัสแล้ว');"
            ...
            <p class="text-gray-400 text-sm mt-2 flex items-center gap-2">
                ...
                <?php echo e(\Carbon\Carbon::parse($order->ord_date)->format('d M Y, เวลา H:i น.')); ?>
        ...
        ?>
        <div class="px-4 py-2 rounded-full border shadow-sm <?php echo e($currentStatus['color']); ?> flex items-center gap-2">
            <i class="fas <?php echo e($currentStatus['icon']); ?>"></i>
            <span class="font-bold text-sm tracking-wide"><?php echo e($currentStatus['label']); ?></span>
        </div>
    </div>
            ...
            <div class="card bg-gray-800 shadow-xl border border-gray-700 overflow-hidden">
                <div class="p-6 border-b border-gray-700 bg-gray-800/50 flex justify-between items-center">
                    <h2 class="text-lg font-bold text-gray-100 flex items-center gap-2">
                        <i class="fas fa-box text-emerald-500"></i> รายการสินค้า (<?php echo e($order->details->sum('ordd_count')); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $order->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr class="hover:bg-gray-700/30 transition-colors group">
                                            ...
                                            <div class="flex flex-col justify-center">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detail->productOption || $detail->option_name): ?>
                                                    <div
                                                        ...
                                                        <?php echo e($detail->productOption->option_name ?? $detail->option_name); ?>
                                    ...
                                    <td class="text-right py-4 align-middle">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($detail->ordd_original_price ?? 0) > ($detail->ordd_price ?? 0)): ?>
                                        ...
                                        <span class="font-bold text-gray-200">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detail->ordd_price == 0): ?>
                                    ...
                                    <td class="text-center align-middle py-4">
                                        <span
                                            ...
                                            x<?php echo e($detail->ordd_count); ?>
                ...
                <div class="p-6 bg-gray-900/30 border-t border-gray-700">
                    <div class="max-w-sm ml-auto space-y-3">
                        <div class="flex justify-between text-sm items-center">
                            ...
                            <span class="font-bold text-gray-200">฿<?php echo e(number_format($order->total_price, 2)); ?></span>
                        </div>
                        <div class="flex justify-between text-sm items-center">
                            <span class="text-gray-400 font-medium">ค่าจัดส่ง</span>
                            <span class="font-bold text-gray-200">฿<?php echo e(number_format($order->shipping_cost, 2)); ?></span>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->total_discount > 0): ?>
                            <div
                                ...
                                <span class="font-bold">-฿<?php echo e(number_format($order->total_discount, 2)); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="flex justify-between items-center pt-2">
                            ...
                            <span
                                class="text-3xl font-black text-emerald-400 drop-shadow-md">฿<?php echo e(number_format($order->net_amount, 2)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-control w-full">
                            ...
                            <div class="flex flex-col gap-3">
                                <select name="status_id"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            ...
            <div class="card bg-gray-800 shadow-xl border border-gray-700">
                ...
                <div class="card-body p-5 space-y-4 text-sm text-gray-300">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="font-bold text-gray-100 text-base"><?php echo e($order->shipping_name); ?></p>
                            <p class="text-xs text-gray-500 mt-0.5">Email: <?php echo e($order->user->email ?? 'ไม่มีอีเมล'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 group">
                        ...
                        <p class="font-medium font-mono text-base tracking-wide"><?php echo e($order->shipping_phone); ?></p>
                    </div>
                    ...
                    <div class="flex items-start gap-4 group">
                        ...
                        <p class="leading-relaxed text-gray-400"><?php echo e($order->shipping_address); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-gray-800 shadow-xl border border-gray-700">
                    ...
                    <div class="card-body p-5 flex flex-col items-center">
                        <div
                            ...
                            <img src="<?php echo e($slipUrl); ?>" alt="Payment Slip"
                            ...
                            <a href="<?php echo e($slipUrl); ?>" target="_blank"
